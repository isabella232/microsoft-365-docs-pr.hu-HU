...
Az Intune-beállítás megkereséséhez jelentkezzen be a Microsoft 365 Business admin hitelesítő adataival, és lépjen a **felügyeleti központokba**, majd az **Intune**.
  
 > [!IMPORTANT]
 > 
 > A Microsoft 365 Business előfizetés engedélyt ad az összes Intune-beállítás módosítására. Az elinduláshoz tekintse meg az [Intune bemutatása](https://docs.microsoft.com/intune/introduction-intune) című témakört.
  
Jelölje ki a kívánt &mdash; házirend-nevet, például az Android &mdash; alkalmazás-házirendet, majd válassza a házirend- **Beállítások**beállítást.
...
|Orrgazdaság kitűző mikor logika megbukik ez sok idő (ez meghibásodott ha kitűző nem szükséges)  <br/> |Próbálkozások száma a PIN-kód alaphelyzetbe állítása előtt  <br/> |
|Annak megkövetelése, hogy a felhasználók ismét bejelentkezhetnek az Office alkalmazások üresjárata után (ez le van tiltva, ha nincs szükség a PIN-kódra)  <br/> | Hozzáférési követelmények újbóli ellenőrzése ennyi idő után (perc)  <br/>  Ez a beállítás az alábbiakat is megadja:  <br/> Az **Időtúllépés** percekben van megadva  <br/>  Ez megegyezik a Microsoft 365 Business esetén megadott percek számával.  <br/> Az **Offline türelmi időszak** alapértelmezés szerint 720 percre van beállítva  <br/> |
...
Az Intune-beállítás megkereséséhez jelentkezzen be a Microsoft 365 Business admin hitelesítő adataival, és lépjen az [Azure portálra](https://portal.azure.com). Jelölje be a **További szolgáltatások**választógombot, és írja be a **szűrőbe**az Intune típust. Válasszuk az **Intune app Protection** \> **app védelmi házirend alkalmazást**.
  
 > [!IMPORTANT]
 >
 >A Microsoft 365 Business előfizetés engedélyt ad arra, hogy csak a Microsoft 365 Business beállításokban szereplő beállításokhoz leképez Intune-beállításokat módosítsa. 
  
A rendelkezésre álló beállítások feltárására jelölje ki a kívánt házirend-nevet, majd válassza az **általános, a hozzárendelések**, az **engedélyezett alkalmazások**, az **adómentes alkalmazások**, a **szükséges beállítások**vagy a **Speciális beállítások** beállítást a bal oldali navigációs ablaktáblában. 
