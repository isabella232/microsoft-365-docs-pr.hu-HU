...
Mikroszkóp 365 van egy egységbe rendezett oldat amit hoz együtt legjobb--ban-osztály termelékenység szerszámok, biztonság, és berendezés vezetés képességek részére kicsi-hoz közeg-méret teendő. A következőket tartalmazza:

**Üzleti termelékenységi és együttműködési eszközök halmaza** 
* Word-, Excel-, PowerPoint-, Outlook-, OneNote-, Publisher-és Access- 
* Exchange, OneDrive, a Skype for Business, a Microsoft csapatok, és a SharePoint. 
* Üzleti alkalmazások Hivatal (Bookings, MileIQ<sup>[1](#footnote1)</sup>). 
 
**Vállalati szintű eszközkezelési és biztonsági lehetőségek** 
- Segít védelmet nyújt a külső fenyegetések, mint az adathalászat és kifinomult malware az Office 365 fejlett fenyegetés védelmi terv 1 és a Windows Defender Exploit Guard. 
-  Segít irányít és kezel hogyan érzékeny információ van kitört és átadás-val Hivatal 365 adat elvesztés megakadályozás politikák és Azure információ védelem tervez 1. 
-  Segít megvédeni, megőrizni és biztonsági másolatot készíteni az adatokról az Exchange Online archiválással.  
-   App védelem az Office és más mobil alkalmazások az Intune app Protection. 
-  Eszközkezelés Windows 10 PC-hez, MacOS-hoz és mobil eszközökhöz az Intune eszközkezelés révén. 
-  Azonosság védelem-val multi--tényező hitelesítés, maga-szolgáltatás jelszó orrgazdaság, és feltételes belépés.
-  Egységes biztonsági konfiguráció az eszközök&mdash;között a Cégadatok védelme eszközök között; Windows Defender programot, amely mindig be-és naprakész. 
 
 
**Egyszerűsített eszköztelepítés és felhasználói beállítás** 
* Egyetlen felügyeleti konzol a felhasználók és eszközök beállításához és kezeléséhez. 
* Az Office-alkalmazások automatikus telepítése Windows 10 PC-ről. 
* Mindig naprakész Office + Windows 10. 
* Egyszerűsített telepítés a PC-k a Windows AutoPilot.

**Egyéb jogosultságok** 
- Mikroszkóp 365 teendő vásárlók is volna belépés-hoz Windows tényleges iskolapad és Hivatal elosztva számítógép aktiválás képességek. További információ a [Microsoft 365 Business blog](https://techcommunity.microsoft.com/t5/Microsoft-365-Business-Blog/bg-p/Microsoft365BusinessBlog) elolvasásához. Lásd még a [Microsoft 365 üzleti szolgáltatás leírását](https://docs.microsoft.com/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-business-service-description).

### <a name="who-should-consider-adopting-microsoft-365-business"></a>Ki kellet volna tekint örökbefogadás Mikroszkóp 365 teendő? 
Mikroszkóp 365 teendő van egy átfogó, felhő-kiindulópontul szolgáló biztonság oldat amit akadályok ön:  
- Védje meg az üzleti ellen haladó cyberfenyegetések kifinomult adathalászat és ransomware védelem. 
- Az érzékeny adatokhoz titkosítás használatával szabályozhatja az adatok véletlen megosztását olyan személlyel, aki számára nem engedélyezett a hozzáférés. 
- Biztonságossá tegye az üzleti vállalkozásaira vonatkozó eszközöket, és segít megőrizni az iOS, Android, Windows és Mac eszközök biztonságát, valamint a Windows-eszközök naprakészen tartaz adatait.

Mikroszkóp 365 teendő van teljesen egységbe rendezett-val Hivatal 365-hoz beszerez ön-val egy családias elhelyezés részére közigazgatás, turbékolás, és 24x7 támogat. Ez áll a vállalati szintű technológia épült vállalkozások kevesebb, mint 300 alkalmazottak. 
...
A Microsoft 365 Business megvásárolható <a href="https://www.microsoft.com/solution-providers/search" target="_blank">Microsoft-partneren</a> vagy közvetlenül a <a href="https://www.microsoft.com//microsoft-365/business" target="_blank">Microsofttól</a>. Annak eldöntéséhez, hogy közvetlenül a Microsofttól vagy a Microsoft-partneren keresztül vásárolható-e, meg kell fontolnia a munkatársak képességeinek és az informatikai infrastruktúra fenntartásának szándékát. A Microsoft-partnerek segíthetnek az IT-infrastruktúra, többek között a Microsoft-megoldások üzembe helyezéséhez és kezeléséhez.
...
Mikroszkóp 365 teendő volt szándékos részére kicsi-hoz közeg-méret teendő-val alacsony-hoz közeg ez bonyolultság igények. Vásárlók tud megvásárol valameddig 300 Mikroszkóp 365 teendő engedélyez részére-uk szervezet. A felhasználók kombinhatják és egyeztethetik a felhőalapú előfizetéseket. Ennek eredményeképpen az informatikai követelményektől függően az ügyfelek ugyanarra a fiókhoz hozzáadhatják a Microsoft 365 Enterprise licenceit. 
 
Mikor vásárlók tekint egy környezet áll vmiből-ból sokszoros aláírás jellegek, ők kellet volna dolgozik-val-uk bízott ez tanácsadók-hoz meghatároz hogyan legjobb-hoz kezel és biztosít a különböző előfizetések mint Mikroszkóp 365 teendő és Mikroszkóp 365 vállalat használ különböző képességekkel rendelkeznek az alkalmazások és adatok biztonságossá és kezeléséhez.
...
Az informatikai környezet szabványosítása segít csökkenteni a karbantartási és biztonsági költségeket idővel és egy olyan állapot, hogy a vállalkozásoknak törekedniük kell a megvalósítására. Azonban tisztában vagyunk azzal, hogy néhány kis-és közepes méretű ügyfél a szoftvereiket elsősorban akkor frissíti, amikor egy hosszabb időszakon keresztül frissítik a hardverüket. A vállalkozások feltelepíthetik a Microsoft 365 Business programot szervezetük egy részére, de az érzékeny üzleti adatok és a következetes együttműködési tapasztalatok legjobb védelme érdekében ajánlott a telepítést minden felhasználó számára.
...
Windows 10 Business egy sor felhő szolgáltatások és eszközgazdálkodási képességeket, amelyek kiegészítik a Windows 10 Pro, és lehetővé teszi a központosított kezelése és biztonsági ellenőrzéseket a Microsoft 365 Business.

Windows 10 teendő is jön-val bizonyos prémium Mikroszkóp védő jellegét meghatározza szeret ellenőr dosszié belépés és hálózat védelem részére pókháló-kiindulópontul szolgáló fonál. Ez is beleértve Windows robotpilóta, egy szolgáltatás amit áramvonalas a felfejlődés-ból új Windows 10 PCs.

Ha olyan eszközei vannak, amelyek licenccel rendelkeznek a Windows 7, 8 és 8,1 Professional operációs rendszerben, a Microsoft 365 Business a Windows 10 Pro rendszerre frissít, ami a Windows 10 Business telepítésének előfeltétele.
> [!IMPORTANT]
...
A Microsoft 365 Business rendszerrel kezelt számítógépeket a Windows Defender program védi, amely a nem. 1 vírusölő vonás-ra Windows 10, megvéd több számítógépek ellen vírus, malware, spyware, és más fenyeget mint akármi más oldat.  -Val Mikroszkóp 365 teendő, szervezetek tud biztosít amit Windows Védő védelem van futás és mindig valameddig időpont-ra-uk Windows 10 berendezés.  
 
Windows 10 üzleti is tartalmazza a Windows Defender Exploit Guard, egy új Behatolás-megelőzési képességek. Egy-ból-a jellegét meghatározza, ellenőr dosszié belépés, megállít ransomware mellett elzárás legyőz tartók és megakadályozás jogosulatlan apps-ból bejutó egy használók ' fontos fájlokat. 
...
Mikroszkóp birtokol különböző termelékenység és biztonság vezetés felajánlás amit kicsi-hoz közeg-méret vásárlók május tekint mikor felminősítő-uk iskolapad és berendezés infrastruktúra, mindegyik hoz mindinkább erős jellegét meghatározza és működési. 
...
**Mikroszkóp 365 teendő** összeköt Hivatal 365 apps és szolgáltatás-val haladó biztonság képességek-hoz segít megvéd-a teendő ellen haladó cyberfenyeget, oltalmaz-a adat és kezel-a berendezés. Ez beleértve egy Simplified Vezetés Vigasztal átmenő melyik berendezés és adat politikák május lenni intézett. Sok kicsi-hoz közeg-méret teendő lehet legjobb szolgál-val Mikroszkóp 365 teendő. 
 
**Mikroszkóp 365 vállalat** van egy készlet-ból engedélyező tervek amit felajánl növelt szintek-ból engedékenység és biztonság vezetés felső Mikroszkóp 365 teendő és van szándékos részére vállalat vásárlók és azok vásárlók amit volna felső 300 használók. Emellett a Microsoft 365 Enterprise tervei további funkciókat is biztosítanak, beleértve az üzleti intelligenciát és az elemzési eszközöket is.
...
Igen, az ügyfelek váltani terveiket a minősített Office 365 terv a Microsoft 365 Business. Attól függően, hogy az ügyfél jelenlegi terve, előfordulhat, hogy csökken, vagy növeli a havi díjakat.

### <a name="in-what-regions-is-microsoft-365-business-available"></a>Milyen régiókban elérhető a Microsoft 365 Business? 
A Microsoft 365 Business minden partner és ügyfél számára elérhető, ahol az Office 365 elérhető. Lát a oldalra dől-ból <a href="https://products.office.com/business/international-availability" target="_blank">hivatal 365 nemzetközi elérhetőség részére nyelvek, országok, és vidék</a>. 
...
Igen, a Microsoft 365 üzleti előfizetők licenccel, hogy teljes Intune képességek iOS, Android, MacOS, és más cross-platform eszközkezelés. A Microsoft 365 Business egyszerűsített kezelőkonzoljában nem elérhető szolgáltatások, mint például a harmadik féltől származó Alkalmazáskezelés és a WiFi profilok konfigurálása, a VPN-tanúsítványok a teljes Intune konzolon kezelhetők. 
...
A Microsoft 365 Business tartalmaz Select Azure prémium P1 (AADP P1) szolgáltatásokat, mint például önkiszolgáló jelszóvisszaállítás az AD write-back, Azure MFA és feltételes hozzáférés funkcióval. Nem tartalmazza a teljes AADP P1-et. További információt a [Microsoft 365 üzleti szolgáltatás leírásában](https://technet.microsoft.com/library/b042d1fd-c997-46d8-8c02-1df4c932f148)talál.
...
A Windows AutoPilot olyan szolgáltatás, amely egyszerűsíti az új Windows 10 PC-k telepítését. Ez folyamat lehet megtett Mikor a végfelhasználó tuskók-ra-hoz Mikroszkóp 365 teendő először&mdash;nélkül ez valaha megható a berendezés&mdash;mellett emelőerő a központosított vezetés vezérlőberendezés-ból Mikroszkóp 365 teendő. A Windows AutoPilot használható a Windows 10 Professional készítők frissítés (vagy újabb) operációs rendszert futtató, gyári újraindító számítógépekre is. Részletek a Windows AutoPilot megtalálható <a href="https://blogs.technet.microsoft.com/windowsitpro/2017/06/29/modernizing-windows-deployment-with-windows-autopilot/" target="_blank">ebben a június 2017 blogbejegyzést</a>.
...
Minden a összead-ons amit lehet hozzáadott-hoz Hivatal 365 teendő prémium lehet hozzáadott-hoz Mikroszkóp 365 teendő. Ez azt jelenti, hogy megvásárolhatja az Office 365 Cloud app Security, fejlett megfelelési, fenyegetés intelligencia, MyAnalytics, PowerBI Pro, és audio konferencia. 
...
A partnerek most értékesítési Office 365 használhatja ugyanazt a konzultációs értékesítési módszerek eladni a Microsoft 365 Business. Ráadásul, vagyunk bemutató több anyagi javak és képzés részére-a eladások csapat-hoz ért a vásárlók ' létező iskolapad környezet, Aktivál Címtár bizalom, mozgékonyság, és biztonság szükséges-hoz hatékonyan kommunikál a teli érték-ból Mikroszkóp 365 Üzleti, olyan módon, amely releváns az ügyfél számára. Ezen erőforrások megkeresése az Office Partnerportálon [https://partners.office.com/microsoft365business](https://partners.office.com/microsoft365business). 
...
A Microsoft Cloud Solution Provider mindig eladja a tervet, amely a legjobban megfelel az ügyfél üzleti igényeit és költségvetését. Ha például egy vevőnek meg kell felelnie a magánélet tiszteletben tartásához és a biztonsági előírásoknak, a CSP értékesítheti a Microsoft 365 Business-ot és minden olyan bővítményt, amelyek segítenek az ügyfélnek az igényeinek megfelelni, vagy a Microsoft 365 Business és speciális biztonsági és kezelési szabályokat javasolhat Vállalat SKUs. 
 
### <a name="some-of-my-customers-have-devices-that-arent-genuine-will-microsoft-365-business-make-these-devices-genuine"></a>Némely-ból az én-m vásárlók volna berendezés amit nem valódi; akarat Mikroszkóp 365 teendő csinál ezek berendezés valódi? 
